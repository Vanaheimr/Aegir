...
namespace eu.Vanaheimr.Aegir
{
    ...
    public class GeoVector
    {
        ...
        /// </summary>
        public GeoCoordinate P { get; private set; }
        ...
        public GeoVector NormVector
        {
            get
            {
                return new GeoVector(new GeoCoordinate(new Latitude (0),
                                                       new Longitude(0)),
                                     new GeoCoordinate(new Latitude (P.Latitude. Value / Length),
                                                       new Longitude(P.Longitude.Value / Length)));
            }
        }
        ...
        public GeoVector(GeoCoordinate GeoCoordinate)
        {
            ...
            this.Length = new GeoCoordinate(new Latitude(0), new Longitude(0)).
