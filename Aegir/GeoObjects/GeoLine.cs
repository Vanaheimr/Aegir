...
namespace org.GraphDefined.Vanaheimr.Aegir
{
    ...
    public class GeoLine
    {
        ...
        public GeoCoordinate Center
        {
            get
            {
                return new GeoCoordinate(new Latitude (P1.Latitude.Value  + (P2.Latitude. Value - P1.Latitude. Value) / 2),
                                         new Longitude(P1.Longitude.Value + (P2.Longitude.Value - P1.Longitude.Value) / 2));
            }
        }
        ...
        public GeoVector Normale
        {
            get
            {
                ...
                return new GeoVector(new GeoCoordinate(new Latitude (-0.44*_Vector.P.Longitude.Value),
                                                       new Longitude(      _Vector.P.Latitude. Value)));
            }
        }
